...
export function addOrIncrementVariantInCart(product: Product, variant: Variant, cart: CartProduct[], addToCart: (item: CartProduct) => void, updateItemQuantity: (itemCode: string, quantity: number) => void) {
