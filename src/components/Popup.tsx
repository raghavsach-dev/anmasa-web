    ...
    <div className="flex items-center justify-center fixed inset-0 bg-black/40 z-[9999]">
      <div className="bg-white p-6 rounded-lg relative w-[1020px] flex gap-4 h-[620px] border border-gray-500">
        ...
        <div className="mt-4 text-sm text-gray-600">
          ...
          <p className="font-medium text-4xl mt-4 text-anmasa-accent">
            {title}
          </p>
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-700 font-medium mb-2">Size</p>
              ...
              {variants &&
                variants.map((variant, index) => (
                  <button
                    ...
                    className={`px-3 py-2 border rounded-lg text-sm ${selectedVariant?.vn === variant.vn ? "bg-anmasa-accent text-anmasa-text border-anmasa-accent" : "border-gray-300 hover:border-anmasa-accent"}`}
                  >
                    {" "}
                    {variant.vn}
                  </button>
